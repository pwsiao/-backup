...
@section('content')
    <div id="content-container">
        ...
        <div id="carpoolform-container">
            ...
            <form action="{{ route('cpform') }}" method="post" id="cpform">
                @csrf
                <div class="inputContainer">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="date" id="departdate1" name="departdate1" required max="{{ $max }}"
                                    min="{{ $min }}"></td>
                        </tr>
                        <tr>
                            <td><label for="returndate1">回程日期 : </label></td>
                            <td><input type="date" id="returndate1" name="returndate1" required max="{{ $max }}"
                                    min="{{ $min }}"> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="note1" name="note1" style="width: 200px;height: 100px;"></textarea>
                            </td>
                        </tr>
                        <!-- <tr>
                ...
                <div class="btns">
                    <a href="{{ route('cphome') }}"><input type="button" value="取消" class="btn"></a>
